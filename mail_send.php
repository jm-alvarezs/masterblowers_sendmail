...
$to = getMail($data['estado'],$data['producto']);

//ini_set('max_execution_time', 0);
//$estados = array(10,11,14,17,24,29);
//
//if(in_array($data['estado'], $estados)){
//    if($data['estado'] == 24 && $data['producto'] == '1'){
//        $to = array('slp@masterblowers.com', 'oficinaslp@masterblowers.com', 'operaciones@masterblowers.com', 'ventas@masterblowers.com', 'publicidad.masterblowers@gmail.com');
//    }else{
